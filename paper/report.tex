...
As the current rsync\footnote{rsync 3.1.1, current as of 12/6/15} is does not have any publically known vulnerabilities, we introduced a sythentic stack buffer overflow into rsync.
