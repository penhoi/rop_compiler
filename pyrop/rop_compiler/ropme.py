...
def rop(files, libraries, goal_list, arch = archinfo.ArchAMD64(), log_level = logging.WARNING):
...
def rop_to_shellcode(files, libraries, shellcode_address, arch = archinfo.ArchAMD64(), log_level = logging.WARNING):
